...
public class ConsistencyCheckService
{
            ...
            CheckConsistencyConfig checkConsistencyConfig ) throws ConsistencyCheckIncompleteException, IOException
    {
        ...
        ConfiguringPageCacheFactory pageCacheFactory = new ConfiguringPageCacheFactory(
                ...
                logProvider.getLog( PageCache.class ), EmptyCursorContextSupplier.INSTANCE );
            ...
            throws ConsistencyCheckIncompleteException
    {
        ...
        StoreFactory factory = new StoreFactory( storeDir, config,
                new DefaultIdGeneratorFactory( fileSystem ), pageCache, fileSystem, logProvider, EmptyCursorContextSupplier.INSTANCE );
